...
describe('AreaSelectorCtrl', () => {
	...
	it('#analyzeSelectedData', () => {
		areaSelectorCtrl.selectedValue = ['310000,310100,310101', '310000,310200', '320000'];
	...
	xit('#ok', () => {
		...
		areaSelectorCtrl.selectedAreas = [[{id: '310000'}, {id: '310100'}, {id: '310101'}], [{id: '310000'}, {id: '310200'}], [{id: '320000'}]];
		areaSelectorCtrl.ok();
