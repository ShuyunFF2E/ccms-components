;(function(angular) {
	...
	angular.module('app', ['ccms.components'])
		...
		.controller('ctrl', function($scope, $ccGoodsSelector) {
			...
			var jsWithShopList = [{shopId: 70866974, shopName: 'JD数云食堂', plat: 'jos'}, {shopId: 11111, shopName: '数云食堂', plat: 'jos'}];
			var taobaoWithoutShopList = {shopId: 70866974, shopName: '数云食堂', plat: 'jos'};
